...
# ----- 查看多筆Images與label ----- #
label_dict = {0:"plastic",1:"papper",2:"glass",3:"iron",4:"aluminum"}
...
model.save('/home/rec_robot/recycle/recycle_other.model')
with open('/home/rec_robot/recycle/batch/label_other', "wb") as fo:
